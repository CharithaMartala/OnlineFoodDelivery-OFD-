...
namespace OnlineFoodDelivery.Controllers
{
    ...
    public class RestaurantController : ControllerBase
    {
        ...
        /* [HttpGet("location/{locationId}")]
            ...
            [HttpGet("location/{Area}")]
            [HttpGet("location/{Pincode}")]
        All of these routes use the same pattern: location/{value} or — GET /api/Restaurant/location/{something}
        just with different parameter names. But ASP.NET Core routing doesn't care 
        about parameter names, only the route structure. So to the framework, they all look like:
